...
export default function PostMessageBody({ postMediaState, mediaType, postId }) {
    return (
        <div
            className="flex justify-center w-full max-h-[900px] border-color4 border-x-2 cursor-pointer"
